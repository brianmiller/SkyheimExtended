...
namespace SkyheimExtended
{
    ...
    public class SkyheimExtended : BaseUnityPlugin
    {
        ...
        void Awake()
        {
            ...
            frostManaScaleFactor = Config.Bind(new ConfigDefinition("Scaling", "frostManaScaleFactor"), 1.35, new ConfigDescription("Max Mana scale factor for Frost type runes--formula: skillLevel * frostManaScaleFactor + 100. scaleWithLevel must be set to true."));
            frostRegenScaleFactor = Config.Bind(new ConfigDefinition("Scaling", "frostRegenScaleFactor"), 0.05, new ConfigDescription("Mana Regen scale factor for Frost type runes--formula: skillLevel * frostRegenScaleFactor + 3. scaleWithLevel must be set to true."));
            fireManaScaleFactor = Config.Bind(new ConfigDefinition("Scaling", "fireManaScaleFactor"), 1.35, new ConfigDescription("Max Mana scale factor for Fire type runes--formula: skillLevel * fireManaScaleFactor + 100. scaleWithLevel must be set to true."));
            fireRegenScaleFactor = Config.Bind(new ConfigDefinition("Scaling", "fireRegenScaleFactor"), 0.05, new ConfigDescription("Mana Regen scale factor for Fire type runes--formula: skillLevel * fireRegenScaleFactor + 3. scaleWithLevel must be set to true."));
            holyManaScaleFactor = Config.Bind(new ConfigDefinition("Scaling", "holyManaScaleFactor"), 1.35, new ConfigDescription("Max Mana scale factor for Holy type runes--formula: skillLevel * holyManaScaleFactor + 100. scaleWithLevel must be set to true."));
            holyRegenScaleFactor = Config.Bind(new ConfigDefinition("Scaling", "holyRegenScaleFactor"), 0.05, new ConfigDescription("Mana Regen scale factor for Holy type runes--formula: skillLevel * holyRegenScaleFactor + 3. scaleWithLevel must be set to true."));
            natureManaScaleFactor = Config.Bind(new ConfigDefinition("Scaling", "natureManaScaleFactor"), 1.35, new ConfigDescription("Max Mana scale factor for Nature type runes--formula: skillLevel * natureManaScaleFactor + 100. scaleWithLevel must be set to true."));
            natureRegenScaleFactor = Config.Bind(new ConfigDefinition("Scaling", "natureRegenScaleFactor"), 0.05, new ConfigDescription("Mana Regen scale factor for Nature type runes--formula: skillLevel * natureRegenScaleFactor + 3. scaleWithLevel must be set to true."));
